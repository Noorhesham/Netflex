...
function SignupForm() {
    ...
    return (
        ...
        className="flex h-full bg-black bg-opacity-60 rounded-md shadow-xl overflow-hidden ">
            <div className=" rounded-md  bg-[url('/signupbg.png')] bg-cover bg-[33rem] w-[23rem]">

            </div>
            <form 
         onSubmit={handleSubmit(onSubmit,onError)} className="flex  flex-col gap-10 text-lg   justify-center  bg-black bg-opacity-60 w-[30rem]
         py-10 px-14 ">
