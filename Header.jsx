      ...
      <div className="flex items-center gap-5 text-2xl  lg:mr-5">
        ...
        <div className="flex items-center text-xl relative">
          ...
          <DropMenu>
            ...
            <li className=" hover:text-white transition-all duration-100 hover:underline"><Link to="account" className="flex items-center gap-2"><PiTelevisionThin/> watch list</Link></li>
